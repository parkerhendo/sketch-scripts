...
/**
 * Run through page and return all unique values for layer opacity
...
module.exports = async (file, page = 0) => {
  logger('#fff', '', '\n✨ Retrieving opacities...')

  // choose target page
  const targetPage = file.pages[page];

  // create array of each layers graphicContextSettings properties
  ...
  logger('#e0e0e0', '', `These have been found in your document: \n${uniqueValues}`);
};
